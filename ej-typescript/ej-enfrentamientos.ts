...
const mostrarEnfrentamientos = (equipos: Array<string>) => {
    ...
    let enfrentamiento: string = equipo2 ? `${equipo1} vs ${equipo2}` : equipo1 + ' ha pasado de ronda';
...
const eliminarEquipo = (equipoEliminar: string, equipos: Array<string>) => {
